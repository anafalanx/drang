...
func TestPathAndEnvBuiltins(t *testing.T) {
	cases := []struct{ name, src, want string }{
		...
		{"is_within-true", `say(is_within("a/b", "a/b/c"))`, "true\n"},
		{"is_within-eq", `say(is_within("a/b", "a/b"))`, "true\n"},
		{"is_within-false", `say(is_within("a/b", "a/x"))`, "false\n"},
		{"is_within-escape", `say(is_within("a/b", "a/b/../.."))`, "false\n"},
